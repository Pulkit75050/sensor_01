...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self,input_dataframe_path:pd.DataFrame):
        ...
        try:
            ...
            input_datraframe : pd.DataFrame = pd.read_csv(input_dataframe_path)

            input_dataframe = input_dataframe.drop(columns= "Unnanamed: 0")if "Unnamed: 0"in input_dataframe.columns else input_dataframe
