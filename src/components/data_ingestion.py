import sys  # for talking to my python interpretator
...
from dataclasses import dataclass # for storing information.
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        try:
            ...
            logging.info(
                "exited initiate_data_ingestion methods of data ingestion class"
            )
